...
let [plugins, ftplugin] = dein#load_cache_raw(['/root/.config/nvim/init.vim'])
...
let &runtimepath = '/root/.config/nvim,/etc/xdg/nvim,/root/.local/share/nvim/site,/usr/local/share/nvim/site,/usr/share/nvim/site,/root/.config/nvim/dein/repos/github.com/Shougo/dein.vim,/root/.config/nvim/dein/.cache/init.vim/.dein,/squashfs-root/usr/share/nvim/runtime,/root/.config/nvim/dein/.cache/init.vim/.dein/after,/usr/share/nvim/site/after,/usr/local/share/nvim/site/after,/root/.local/share/nvim/site/after,/etc/xdg/nvim/after,/root/.config/nvim/after'
filetype off
